...
> Python client SDK for interacting with the core inference API - part of the [NeuralBase](https://github.com/NeuralBase) open-source ecosystem.
...
The `sdk` package provides the Python interface for integrating with NeuralBase's infrastructure, designed for ease of use in both scripts and production services.
...
```bash
git clone https://github.com/NeuralBase/sdk
cd sdk
pip install -e .
```
...
- **GitHub Issues:** [github.com/NeuralBase/issues](https://github.com/NeuralBase)
- **Discussions:** [github.com/NeuralBase/discussions](https://github.com/NeuralBase)
